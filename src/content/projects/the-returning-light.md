...
imageAlt: "Default site graphic used until cover art or fuller metadata is supplied for The Returning Light."
links:
  - label: "Amazon.ca"
    url: "https://www.amazon.ca/dp/B0G1YMGY2Q/"
---
This entry records *The Returning Light* as a self-published book available on Amazon. The site keeps the claim boundary tight: title, authorship, self-published status, and the Amazon listing are included, while fuller edition-specific details can still be added later.
